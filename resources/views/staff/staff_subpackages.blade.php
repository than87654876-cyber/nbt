                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('nhanvien.goidichvu_chinhsua') }}" type="button"
                                                    class="btn btn-sm btn-light btn-block border">Cấu
                                                    hình thực đơn</a>
                                            </td>
                                        </tr>
                                        <tr class="table-danger">
                                            <td class="font-weight-bold text-primary">Gói Công Ty Tuần</td>
                                            <td><a href="#" class="font-weight-bold text-dark">#FDL-7731</a></td>
                                            <td>12/06/2026</td>
                                            <td>Khách vãng lai<br><small class="text-muted">0912345678</small></td>
                                            <td><span class="badge badge-success px-2 py-1">Đã tất toán</span></td>
                                            <td class="font-weight-bold text-danger">Đã dừng hợp đồng<br><small
                                                    class="text-danger">(Hủy ngày thứ 5)</small></td>
                                            <td><span class="badge badge-secondary px-2 py-1"><i class="fas fa-ban"></i>
                                                    Ngừng cấp món</span></td>
                                            <td>
                                                <button type="button"
                                                    class="btn btn-sm btn-light border btn-block text-dark" disabled>Đã
                                                    khóa</button>
                                            </td>
                                        </tr>
                                    </tbody>
