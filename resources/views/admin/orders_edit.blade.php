...
<head>
    ...
    <title>Chỉnh sửa đơn hàng - FOODELICIOUS</title>
                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">Cập nhật tiến trình đơn hàng #FDL-8892</h1>
                                <a href="{{ route('quanly_donhang') }}" class="btn btn-sm btn-secondary shadow-sm"><i
                                        class="fas fa-undo fa-sm"></i> Hủy và Quay lại</a>
                            </div>

                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Biểu mẫu điều phối trạng thái đơn vận
                                    </h6>
                                </div>
                                    ...
                                    <form action="#" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control bg-light" value="#FDL-8892"
                                                    readonly>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label class="font-weight-bold">Khách hàng đặt hàng</label>
                                                <input type="text" class="form-control bg-light" value="Dương Bá Tùng"
                                                    readonly>
                                            </div>
                                            <div class="form-group col-md-4">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label for="order_status" class="font-weight-bold text-primary"><i
                                                        class="fas fa-tasks mr-1"></i>Trạng thái đơn hàng</label>
                                                <select class="form-control border-left-primary font-weight-bold"
                                                    id="order_status" name="order_status">
                                                    <option value="pending">Chờ xác nhận đơn (Pending)</option>
                                                    <option value="confirmed">Đã xác nhận đơn - Đang chuẩn bị món
                                                    </option>
                                                    <option value="shipping" selected>Xác nhận giao - Đang giao hàng
                                                        (Shipping)
                                                    </option>
                                                    <option value="completed">Đã hoàn thành - Thành công (Completed)
                                                    </option>
                                                    <option value="cancelled" class="text-danger">Hủy đơn hàng
                                                        (Cancelled)
                                                    </option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="payment_status" class="font-weight-bold text-success"><i
                                                        class="fas fa-money-check-alt mr-1"></i>Trạng thái thanh toán
                                                    dòng
                                                    tiền</label>
                                                <select class="form-control border-left-success font-weight-bold"
                                                    id="payment_status" name="payment_status">
                                                    <option value="unpaid">Chưa thanh toán (Unpaid)</option>
                                                    <option value="paid" selected>Xác nhận đã thanh toán thành công
                                                        (Paid)
                                                    </option>
                                                    <option value="refunded" class="text-secondary">Đã xử lý hoàn tiền
                                                        (Refunded)</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-2">
                                            <div class="form-group col-md-12">
                                                <label for="admin_notes" class="font-weight-bold">Ghi chú điều phối / Lý
                                                    do hủy
                                                    đơn (Nếu có)</label>
                                                <textarea class="form-control" id="admin_notes" name="admin_notes"
                                                    rows="3"
                                                    placeholder="Nhập ghi chú cho nhân viên bếp hoặc shipper liên tỉnh nếu cần..."></textarea>
                                            </div>
                                        </div>
