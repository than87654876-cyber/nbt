...
<head>
    ...
    <title>Quản lý Hoàn tiền - FOODELICIOUS</title>

    <!-- Các tệp CSS nguồn từ Template gốc -->
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Danh sách Đơn khiếu nại & Hoàn trả
                                        dòng tiền
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered text-dark" id="dataTable" width="100%"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td class="font-weight-bold">Dương Bá Tùng<br><small
                                                            class="text-muted">0901234567</small></td>
                                                    <td>17/06/2026 10:15</td>
                                                    <td><a href="#" class="font-weight-bold text-primary">#FDL-7531</a>
                                                    </td>
                                                    <td class="font-weight-bold text-danger">45.000 đ</td>
                                                    <td><span class="badge badge-warning text-dark"><i
                                                                class="fas fa-clock"></i>
                                                            Đang chờ duyệt</span></td>
                                                    <td>
                                                        <a href="{{ route('yeucauhoan_xem') }}"
                                                ...
                                                <tr>
                                                    <td>2</td>
                                                    <td class="font-weight-bold">Lê Thành Nam<br><small
                                                            class="text-muted">0945678901</small></td>
                                                    <td>05/06/2026 09:20</td>
                                                    <td><a href="#" class="font-weight-bold text-primary">#FDL-6102</a>
                                                    </td>
                                                    <td class="font-weight-bold text-dark">89.000 đ</td>
