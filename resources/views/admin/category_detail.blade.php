...
<head>
    ...
    <title>Chi tiết Danh mục - FOODELICIOUS</title>
                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">Chi tiết danh mục: Cơm</h1>
                                    ...
                                    <div class="card shadow mb-4 border-left-info text-dark">
                                        <div class="card-header py-3">
                                            <h6 class="m-0 font-weight-bold text-info"><i
                                                    class="fas fa-folder-open mr-2"></i>Thông tin cấu hình</h6>
                                        </div>
                                        <div class="card-body">
                                            <p class="mb-2"><strong>Tên danh mục:</strong> Cơm</p>
                                            <p class="mb-2"><strong>Ngày thiết lập tạo:</strong> 12/01/2026 14:22</p>
                                            <p class="mb-2"><strong>Cập nhật cuối:</strong> 22/06/2026 09:10</p>
                                            <p class="mb-3"><strong>Mô tả hệ thống:</strong> Các món cơm tấm, cơm chiên
                                                văn
                                                phòng phục vụ trưa và tối cho phân hệ đặt đơn hỏa tốc hoặc đăng ký gói.
                                            </p>
                                            <a href="edit_category.html"
                                                class="btn btn-warning btn-sm btn-block font-weight-bold"><i
                                                    class="fas fa-edit"></i> Chỉnh sửa danh mục</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card shadow mb-4 text-dark">
                                        <div class="card-header py-3">
                                            <h6 class="m-0 font-weight-bold text-primary"><i
                                                    class="fas fa-hamburger mr-2"></i>Danh sách thực phẩm trong nhóm
                                            </h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered mb-0" id="dataTable"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>1</td>
                                                            <td class="font-weight-bold">Cơm Tấm Sườn Bì Chả</td>
                                                            <td class="text-danger font-weight-bold">50,000 đ</td>
                                                            <td>20 phần</td>
                                                        </tr>
                                                        <tr>
                                                            <td>2</td>
                                                            <td class="font-weight-bold">Cơm Chiên Dương Châu</td>
                                                            <td class="text-danger font-weight-bold">55,000 đ</td>
                                                            <td>19 phần</td>
                                                        </tr>
                                                        <tr>
                                                            <td>3</td>
                                                            <td class="font-weight-bold">Cơm Gà Hainanese</td>
                                                            <td class="text-danger font-weight-bold">52,000 đ</td>
                                                            <td>24 phần</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
