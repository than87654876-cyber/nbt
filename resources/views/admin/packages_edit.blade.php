                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <input type="text" class="form-control" id="combo_name" name="combo_name" value="Combo Tiết Kiệm Sáng - Trưa" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="created_at" class="font-weight-bold text-dark">Ngày tạo gói</label>
                                <input type="date" class="form-control" id="created_at" name="created_at" value="2026-06-15">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" class="form-control text-danger font-weight-bold" id="combo_price" name="combo_price" value="89000" required min="0">
                            </div>
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <small class="text-muted">Ảnh hiện tại: <img src="{{ asset('logo.jpg') }}" class="img-thumbnail ml-1" style="max-height: 40px;"></small>
                            </div>
                        </div>
                    </div>
                </div>
