...
<head>
    ...
    <title>Chi tiết khách hàng - FOODELICIOUS</title>
                                ...
                                <div class="col-lg-4 mb-4">
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <h5 class="font-weight-bold text-dark mb-1">Dương Bá Tùng</h5>
                                            <p class="text-muted small mb-2">Mã hội viên: <span
                                                    class="font-weight-bold">KH-001</span></p>
                                            <span class="badge badge-danger px-3 py-2">Hạng: Kim Cương</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-8 mb-4">
                                    <div class="card shadow mb-4">
                                        <div
                                            ...
                                            <h6 class="m-0 font-weight-bold text-primary">Thông tin cá nhân & Lịch sử
                                                tích điểm
                                            </h6>
                                            ...
                                            <table class="table table-bordered text-dark mb-0">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="font-weight-bold text-primary">Dương Bá Tùng</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-success font-weight-bold">2.450 Điểm</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Khách quen phân hiệu, thường dùng dịch vụ giao hàng Grab nội
                                                            thành
                                                            Ho Chi Minh City.</td>
                                                    </tr>
                                                </tbody>
