...
<head>
    ...
    <title>Chi tiết chương trình khuyến mãi - FOODELICIOUS</title>
                                ...
                                <div class="col-lg-4 mb-4">
                                    <div class="card shadow mb-4">
                                        <div class="card-header py-3">
                                            <h6 class="m-0 font-weight-bold text-primary">Hình ảnh chương trình</h6>
                                        </div>
                                        <div class="card-body text-center">
                                            <img src="logo.jpg" alt="Hình ảnh khuyến mãi"
                                ...
                                <div class="col-lg-8 mb-4">
                                    <div class="card shadow mb-4">
                                        <div
                                            ...
                                            <h6 class="m-0 font-weight-bold text-primary">Thông tin cấu hình ưu đãi</h6>
                                            <a href="#" class="btn btn-sm btn-warning shadow-sm">
                                                <i class="fas fa-edit fa-sm"></i> Chỉnh sửa chương trình
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <table class="table table-bordered text-dark mb-0">
                                                <tbody>
                                                    <tr>
                                                        <th style="width: 30%">Số thứ tự (ID):</th>
                                                        <td class="font-weight-bold">#1</td>
                                                    </tr>
                                                    <tr>
                                                        <th>Tên chương trình:</th>
                                                        <td class="font-weight-bold text-primary">Hè giải nhiệt</td>
                                                    </tr>
                                                    <tr>
                                                        <th>Mã giảm giá (Nếu có):</th>
                                                        <td><span class="badge badge-dark">HE2026</span></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Điều kiện áp dụng:</th>
                                                        <td class="text-secondary font-weight-bold">Mua 1 Phở Bò</td>
                                                    </tr>
                                                    <tr>
                                                        <th>Khuyến mãi nhận được:</th>
                                                        <td class="text-success font-weight-bold">Tặng 1 Tiramisu</td>
                                                    </tr>
                                                    <tr>
                                                        <th>Thời hạn chương trình:</th>
                                                        <td><i class="far fa-clock mr-1 text-danger"></i> Đến 30/06/2026
                                                        </td>
                                                    </tr>
                                                    <tr>
