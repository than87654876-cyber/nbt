...
<head>
    ...
    <title>Chi tiết đăng ký gói - FOODELICIOUS</title>
                        ...
                        <div class="container-fluid">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                ...
                                <a href="{{ route('quanly_goidangky') }}" class="btn btn-sm btn-secondary shadow-sm"><i
                                        class="fas fa-arrow-left fa-sm"></i> Quay lại</a>
                            </div>
                            ...
                            <div class="card shadow mb-4">
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary"><i
                                            class="fas fa-info-circle me-1"></i>Thông
                                        tin tổng quan dịch vụ</h6>
                                    <a href="edit_sub.html" class="btn btn-warning btn-sm fw-bold"><i
                                            class="fas fa-edit"></i>
                                        Chỉnh sửa & Tạo đơn hàng ngày</a>
                                </div>
                                <div class="card-body text-dark">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p class="mb-2"><strong>Tên gói dịch vụ:</strong> Gói Gia Đình Hàng Ngày (30
                                                ngày)
                                            </p>
                                            <p class="mb-2"><strong>Khách hàng:</strong> Dương Bá Tùng (SĐT: 0901234567)
                                            </p>
                                            <p class="mb-2"><strong>Mã hóa đơn gốc:</strong> <span
                                                    class="text-danger font-weight-bold">#FDL-6102</span></p>
                                            <p class="mb-0"><strong>Nơi nhận:</strong> Trường Cao đẳng Công nghệ Thông
                                                tin
                                                TP.HCM (ITC)</p>
                                        </div>
                                        <div class="col-md-6 border-left border-md">
                                            <p class="mb-2"><strong>Ngày đăng ký kích hoạt:</strong> 01/06/2026</p>
                                            <p class="mb-2"><strong>Ngày kết thúc dự kiến:</strong> 30/06/2026</p>
                                            <p class="mb-2"><strong>Tiến độ hiện tại:</strong> Ngày thứ <span
                                                    class="badge bg-primary text-white fw-bold">18 / 30</span></p>
                                            <p class="mb-0"><strong>Thời gian kiểm tra:</strong> 17/06/2026</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary"><i
                                            class="fas fa-calendar-alt me-1"></i>Nhật
                                        ký thực đơn & Trạng thái giao theo ngày</h6>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped text-dark mb-0">
                                            <thead class="bg-gradient-light text-center">
                                                <tr>
                                                    ...
                                                    <th style="width: 20%">Ngày giao thực tế</th>
                                                    <th style="width: 40%">Thực đơn chỉ định giao</th>
                                                    <th style="width: 25%">Trạng thái vận đơn hàng ngày</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td class="text-center font-weight-bold">Ngày 17</td>
                                                    <td class="text-center">16/06/2026</td>
                                                    <td>Phở Bò Đặc Biệt + Cà phê sữa đá</td>
                                                    <td class="text-center"><span class="badge badge-success"><i
                                                                class="fas fa-check"></i> Đã hoàn thành</span></td>
                                                </tr>
                                                <tr class="table-primary">
                                                    <td class="text-center font-weight-bold">Ngày 18 (Hôm nay)</td>
                                                    <td class="text-center font-weight-bold">17/06/2026</td>
                                                    <td class="font-weight-bold text-primary">Cơm tấm sườn bì chả + Nước
                                                        ngọt
                                                        chanh dây</td>
                                                    <td class="text-center"><span
                                                            class="badge badge-warning text-dark"><i
                                                                class="fas fa-shipping-fast"></i> Đang giao hàng</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center font-weight-bold">Ngày 19</td>
                                                    <td class="text-center">18/06/2026</td>
                                                    <td class="text-muted">Bún bò Huế giò gân + Trà đào sả cam</td>
                                                    <td class="text-center"><span class="badge badge-secondary">Chưa đến
                                                            ngày</span></td>
                                                </tr>
                                            </tbody>
                                        </table>
