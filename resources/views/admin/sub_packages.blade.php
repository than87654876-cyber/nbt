...
<head>
    ...
    <title>Quản lý Đăng ký Gói - FOODELICIOUS</title>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Danh sách khách hàng đang sử dụng gói
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered text-dark" id="dataTable" width="100%"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td class="font-weight-bold">Gói Gia Đình Hàng Ngày</td>
                                                    <td><a href="#"
                                                            class="font-weight-bold text-underline">#FDL-6102</a></td>
                                                    <td>Dương Bá Tùng<br><small class="text-muted">0901234567</small>
                                                    </td>
                                                    <td><span class="badge badge-success">Đã thanh toán</span></td>
                                                    <td><span class="badge badge-info">Còn 12 ngày</span></td>
                                                    <td>
                                                        <a href="{{ route('goidangky_xem') }}"
                                                            class="btn btn-info btn-sm"><i class="fas fa-eye"></i>
                                                            Xem</a>
                                                        <a href="{{ route('goidangky_chinhsua') }}"
                                                ...
                                                <tr>
                                                    <td>2</td>
                                                    <td class="font-weight-bold">Gói Công Ty Tuần</td>
                                                    <td><a href="#"
                                                            class="font-weight-bold text-underline">#FDL-7731</a></td>
                                                    <td>Khách vãng lai<br><small class="text-muted">0912345678</small>
                                                    </td>
                                                    <td><span class="badge badge-success">Đã thanh toán</span></td>
                                                    <td><span class="badge badge-danger">Đã hủy gói</span></td>
                                                    <td>
