...
<head>
    ...
    <title>Quản lý Danh mục - FOODELICIOUS</title>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered text-dark" id="dataTable" width="100%"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td class="font-weight-bold text-primary">Cơm</td>
                                            <td class="text-center font-weight-bold">14 món</td>
                                            <td>Các món cơm tấm, cơm chiên văn phòng phục vụ trưa và tối</td>
                                            <td>
                                                <a href="{{ route('danhmuc_xem') }}" class="btn btn-info btn-sm"><i
                                                        class="fas fa-eye"></i> Xem</a>
                                                <a href="{{ route('danhmuc_chinhsua') }}"
                                        ...
                                        <tr>
                                            <td>2</td>
                                            <td class="font-weight-bold text-primary">Phở</td>
                                            <td class="text-center font-weight-bold">8 món</td>
                                            <td>Phở bò, phở gà nước dùng hầm xương phin truyền thống</td>
                                            <td>
                                                <a href="#" class="btn btn-info btn-sm"><i class="fas fa-eye"></i>
                                                    Xem</a>
                                        ...
                                        <tr>
                                            <td>3</td>
                                            <td class="font-weight-bold text-primary">Bánh Mì</td>
                                            <td class="text-center font-weight-bold">12 món</td>
                                            <td>Bánh mì kẹp các loại phục vụ ăn nhanh buổi sáng linh hoạt</td>
                                            <td>
                                                <a href="#" class="btn btn-info btn-sm"><i class="fas fa-eye"></i>
                                                    Xem</a>
                                                <a href="#" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i>
